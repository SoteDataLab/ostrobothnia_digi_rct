...
### ### ### ### ### ### ### ### ### ### ### ### ### ### #
### ### ### ### ### ### ### ### ### ### ### ### ### ### #
###       r-script master_script_sap_populated.R      ###
###                 Replication file.                 ###
###                    2026 by TH, MS                 ###
### ### ### ### ### ### ### ### ### ### ### ### ### ### #
### ### ### ### ### ### ### ### ### ### ### ### ### ### #

# Content: The order in which R scripts should be run (populated SAP).
rm(list=ls())
...
writeLines(capture.output(sessionInfo()), 'sessionInfo_sap_populated.txt')


# Data extraction and cleaning:
#source(file = "~/DATAINFRA/master_script_datainfra.R")

# Read the study population and their characteristics.
